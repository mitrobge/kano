...
class Services 
{
	...
	public static function GetCategory($categoryId, $languageId = null)
	{
        ...
        // Build SQL query
		$sql = 'CALL services_get_category(:category_id, :language_id)';
    ...
    public static function GetServices($categoryId, $languageId = null)
    {
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
        ...
        // Build SQL query
		$sql = 'CALL services_get_services(:category_id, :language_id)';
	...
	public static function GetServiceDetails ($serviceId, $languageId = null)
	{
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
        ...
        // Build SQL query
		$sql = 'CALL services_get_service_details(:service_id, :language_id)';
        ...
        public static function GetCategoryName($categoryId, $languageId = null)
        {
            ...
            // Build SQL query
            $sql = 'CALL services_get_category_name(:category_id, :language_id)';
        ...
        {
            // Build SQL query
            $sql = 'CALL services_delete_category(:category_id, :force_delete)';
	...
	public static function GetCategoryDetails($categoryId, $languageId = null)
	{
        ...
        // Build SQL query
		$sql = 'CALL services_get_category_details(:category_id, :language_id)';
    ...
    public static function AddCategory($parentId = null, $isEdu = false)
    {
        // Build SQL query
        $sql = 'CALL services_add_category(:parent_id, :is_edu)';
    ...
    {
		// Build SQL query
        $sql = 'CALL services_set_category_name(:category_id, 
    ...
    public static function GetServiceDefaultTabs($serviceId, $languageId)
    {
		// Build SQL query
        $sql = 'CALL services_get_service_available_default_tabs(:service_id, :language_id)';
    ...
    public static function GetServiceParent($serviceId, $languageId)
    {
        // Build SQL query
        $sql = 'CALL services_get_service_parent(:service_id, :language_id)';
	// Build the parameters array
        $params = array(':service_id' => $serviceId, 
                        ':language_id' => $languageId);
    ...
    public static function GetServiceName($serviceId, $languageId = null)
    {
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
		...
		// Build SQL query
		$sql = 'CALL services_get_service_name(:service_id, :language_id)';
    ...
    public static function GetServiceDescription($serviceId, $languageId = null)
    {
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
		...
		// Build SQL query
		$sql = 'CALL services_get_service_description(:service_id, :language_id)';
    ...
    public static function GetServiceResources($serviceId, $resourceType = null, $languageId = null)
    {
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
        ...
        // Build SQL query
        $sql = 'CALL services_get_service_resources(:service_id, :resource_type, :language_id)';
    ...
    public static function GetServiceAllResources($serviceId, $languageId = null)
    {
        // Get current session's languageId if not specified
        if (is_null($languageId))
            $languageId = Language::Get();
        ...
        // Build SQL query
        $sql = 'CALL services_get_service_all_resources(:service_id, :language_id)';
    ...
    public static function GetServiceRelatedNews($serviceId)
    {
        
        // Build SQL query
        $sql = 'CALL services_get_service_related_news(:service_id)';
        ...
        public static function GetCategoryChildren($categoryId = null, $languageId = null)
    {
        ...
        // Build SQL query
		$sql = 'CALL services_get_category_children(:category_id, :language_id)';
    ...
    // Build SQL query
    $sql = 'CALL services_get_education_application_forms()';
    ...
    // Build SQL query
    $sql = 'CALL services_get_education_application_form_details(:application_id)';
    ...
    public static function GetServiceRelatedSeminars($serviceId)
    {
        
        // Build SQL query
        $sql = 'CALL services_get_education_seminars(:service_id)';
    ...
    public static function GetServiceRelatedSeminar($seminarId)
    {
        
        // Build SQL query
        $sql = 'CALL services_get_education_seminar(:seminar_id)';
    ...
    // Build SQL query
    $sql = 'CALL services_get_education_seminars()';
                               ...
                               $seminarsPerPage = SEMINARS_PER_PAGE_ADMIN)
    {
        ...
        // Build the SQL query
        $sql = 'CALL services_get_seminars_by_filters(:customer_id, :status, :start_date, 
                               ...
                               $seminarsPerPage = SEMINARS_PER_PAGE_ADMIN)
    {
        ...
        // Build the SQL query
        $sql = 'CALL services_get_seminars(:seminars_per_page, :start_item)';
